...
export const TRACE_STORAGE_DOMAIN_MANIFEST = Object.freeze([
  ...
  {
    key: "tracePhotoStorage/media/*",
    storage: "indexedDB",
    classification: STORAGE_DOMAIN_CLASSIFICATION.DURABLE_BACKUP,
    backupLocation: "data.media",
    owner: "photoStorage / timeCapsule",
    description: "Time Capsule photo, audio, and video blobs with durable ownership metadata.",
  },
